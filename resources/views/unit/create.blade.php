            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-3">Tambah Satuan</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form id="formupdate" autocomplete="off" method="post" action="/units" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
