                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ubah Judul Tabel</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-3">Ubah Judul Tabel</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form id="formupdate" autocomplete="off" method="post" action="/indicators/{{$indicator->id}}" class="needs-validation" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="subject" name="subject" class="form-control" data-toggle="select" name="subject" required>
                                        ...
                                        <option value="{{ $subject->id }}" {{ old('subject', $indicator->subject_id) == $subject->id ? 'selected' : '' }}>
                                            {{ $subject->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="validationCustom03" value="{{ @old('name', $indicator->name) }}">
                                    @error('name')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="source" class="form-control @error('source') is-invalid @enderror" id="validationCustom03" value="{{ @old('source', $indicator->source) }}">
                                    @error('source')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="characteristic" name="characteristic" class="form-control" data-toggle="select" name="characteristic" required>
                                        ...
                                        <option value="" {{ old('characteristic', $indicator->characteristic_id) == null ? 'selected' : '' }}> Tidak ada Judul Kolom </option>
                                        @foreach ($characteristics as $characteristic)
                                        <option value="{{ $characteristic->id }}" {{ old('characteristic', $indicator->characteristic_id) == $characteristic->id ? 'selected' : '' }}>
                                            {{ $characteristic->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="row" name="row" class="form-control" data-toggle="select" name="row" required>
                                        ...
                                        @foreach ($rows as $row)
                                        <option value="{{ $row->id }}" {{ old('row', $indicator->row_id) == $row->id ? 'selected' : '' }}>
                                            {{ $row->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="period" name="period" class="form-control" data-toggle="select" name="period" required>
                                        ...
                                        <option value="{{ $period->id }}" {{ old('period', $indicator->period_id) == $period->id ? 'selected' : '' }}>
                                            {{ $period->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="unit" name="unit" class="form-control" data-toggle="select" name="unit" required>
                                        ...
                                        <option value="" {{ old('unit', $indicator->unit_id) == null ? 'selected' : '' }}> Tidak ada Satuan </option>
                                        @foreach ($units as $unit)
                                        <option value="{{ $unit->id }}" {{ old('unit', $indicator->unit_id) == $unit->id ? 'selected' : '' }}>
                                            {{ $unit->name }}
                                        </option>
                                        @endforeach
                                    </select>
