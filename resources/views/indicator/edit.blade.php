                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ubah Indikator</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-3">Ubah Indikator</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="characteristic" name="characteristic" class="form-control" data-toggle="select" name="characteristic" required>
                                        ...
                                        <option value="" {{ old('characteristic', $indicator->characteristic_id) == null ? 'selected' : '' }}> Tidak ada Karakteristik </option>
