            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-3">Tambah Periode</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form id="formupdate" autocomplete="off" method="post" action="/periods" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <label class="form-control-label" for="step">Daftar Item Periode</label>
                                    <div class="row">
